...
Begin VB.Form FrmAddArt2 
   BackColor       =   &H00FF0000&
   Caption         =   "Añadir Artículos - 2"
   ClientHeight    =   10800
   ClientLeft      =   1170
   ClientTop       =   405
   ClientWidth     =   15270
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmaddart2.frx":0000
      Height          =   3495
      Left            =   0
      OleObjectBlob   =   "frmaddart2.frx":0014
      TabIndex        =   48
      Top             =   7320
      Width           =   15255
   End
   ...
   Begin VB.ComboBox comrebaja 
      Height          =   315
      ItemData        =   "frmaddart2.frx":09E7
      Left            =   4560
      List            =   "frmaddart2.frx":09E9
      TabIndex        =   7
      Text            =   "0"
      Top             =   2280
      Width           =   855
   ...
   Begin VB.ComboBox cmbtalla 
      Height          =   315
      ItemData        =   "frmaddart2.frx":09EB
      Left            =   2040
      List            =   "frmaddart2.frx":09ED
      TabIndex        =   12
      Top             =   3600
      Width           =   1455
   End
   Begin VB.ComboBox cmbcolor 
      Height          =   315
      ItemData        =   "frmaddart2.frx":09EF
      Left            =   2040
      List            =   "frmaddart2.frx":09F1
      TabIndex        =   9
      Top             =   3120
      Width           =   735
   End
...
For i = 1 To cmbveces.Text
    ...
    !foto = txtFields(11)
    !fotoweb = RutaWebImg & txtFields(11)
     .Update
     .MoveLast
    Next i
End With
...
Private Sub Form_Load()
    RutaWebImg = "http://www.canelamoda.es/ps/img/p/"
    Repetidos = 1
...
Private Sub txtFields_GotFocus(Index As Integer)
    ...
    txtFields(Index).BackColor = vbGreen
    End If
End Sub
