...
Begin VB.Form FrmEtiquetas 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmetiquetas.frx":0000
      Height          =   5535
      Left            =   0
      OleObjectBlob   =   "frmetiquetas.frx":0013
      TabIndex        =   21
      Top             =   1440
      Width           =   13095
   End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Cmbalto 
         Height          =   315
         ItemData        =   "frmetiquetas.frx":09E6
         Left            =   840
         List            =   "frmetiquetas.frx":09E8
         TabIndex        =   11
         Text            =   "35"
         Top             =   840
         Width           =   735
